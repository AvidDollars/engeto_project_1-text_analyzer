...
from utils import AuthUsersLoader, Auth, TextLoader, TextAnalysis, TokenizedText
from constants import TEXT_1, TEXT_2, TEXT_3, AUTH_USERS_JSON, HR_LINE
import sys
...
def ask_user_for_valid_index() -> int:
    ...
    is_valid_index = lambda input_: input_.isnumeric() and 1 <= int(input_) <= len(TEXTS)
...
def authenticate_user() -> str:
    ...
    user_has_access = auth.has_access(username=provided_username, password=provided_password)
...
def text_analysis(*, index_of_text: int) -> None:
    """
